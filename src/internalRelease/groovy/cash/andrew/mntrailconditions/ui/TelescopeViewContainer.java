...
public final class TelescopeViewContainer implements ViewContainer {
  ...
  @Inject
  public TelescopeViewContainer(
      LumberYard lumberYard, RxSharedPreferences preferences, IntentManager intentManager) {
        ...
        new Lens() {
          ...
          public void onCapture(File file) {
            ...
            Context toastContext =
                new ContextThemeWrapper(activity, android.R.style.Theme_DeviceDefault_Dialog);
